...
$query = "SELECT * FROM accounts WHERE admin BETWEEN 1 AND 13 ORDER BY admin DESC";
$result = mysqli_query($conn, $query);
?>
...
<body>
    ...
    <?php if ($admin_edit): ?>
        <a href="edit_admin.php?nickname=<?php echo $row['name']; ?>">
    ...
    <?php if ($admin_delete): ?>
        <a href="delete_admin.php?nickname=<?php echo $row['name']; ?>">
